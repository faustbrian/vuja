...
import (
	...
	_ "github.com/faustbrian/vuja/commands/runner"
...
func TestJustGenerator(t *testing.T) {
	...
	res := s.Generator(context.Background(), []string{"just", ""}, "just ", "")
	...
	resMissing := s.Generator(context.Background(), []string{"just", ""}, "just ", "")
	if resMissing != nil {
