...
var DefaultContextRules = []ContextRule{
	...
	&SimpleContextRule{
		check: func(ws workspace.WorkspaceInfo, cmd string) bool {
			return ws.GitMerging && (cmd == "git merge --continue" || cmd == "git merge --abort")
		},
		bonus: 60,
	},
	&SimpleContextRule{
		check: func(ws workspace.WorkspaceInfo, cmd string) bool {
			return ws.GitRebasing && (cmd == "git rebase --continue" || cmd == "git rebase --abort")
		},
		bonus: 60,
	},
	&SimpleContextRule{
		check: func(ws workspace.WorkspaceInfo, cmd string) bool {
			return ws.GitCherryPicking && (cmd == "git cherry-pick --continue" || cmd == "git cherry-pick --abort")
		},
		bonus: 60,
	},
	&SimpleContextRule{
