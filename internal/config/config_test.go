...
func TestDefaultConfigAndState(t *testing.T) {
	...
	if cfg.Keybindings.NavigationUp != "up" || cfg.Keybindings.NavigationDown != "down" ||
		cfg.Keybindings.NavigationPageUp != "page-up" || cfg.Keybindings.NavigationPageDown != "page-down" ||
		cfg.Keybindings.NavigationFirst != "none" || cfg.Keybindings.NavigationLast != "none" {
		t.Errorf("unexpected default navigation keybindings: %+v", cfg.Keybindings)
	}
...
`,
		...
		{
			name: "conflicting navigation action",
			content: `
[keybindings]
history-search = "ctrl+r"
navigation-up = "ctrl+r"
`,
		},
		{
...
`), 0644); err != nil {
	...
	if cfg.Keybindings.HistorySearch != "ctrl+g" ||
		...
		cfg.Keybindings.NavigationUp != "ctrl+p" ||
		cfg.Keybindings.NavigationDown != "ctrl+d" ||
		cfg.Keybindings.NavigationPageUp != "page-up" ||
		cfg.Keybindings.NavigationPageDown != "page-down" ||
		cfg.Keybindings.NavigationFirst != "home" ||
		cfg.Keybindings.NavigationLast != "end" {
