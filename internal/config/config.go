...
type KeybindingsConfig struct {
	...
	NavigationUp       string   `toml:"navigation-up"`
	NavigationDown     string   `toml:"navigation-down"`
	NavigationPageUp   string   `toml:"navigation-page-up"`
	NavigationPageDown string   `toml:"navigation-page-down"`
	NavigationFirst    string   `toml:"navigation-first"`
	NavigationLast     string   `toml:"navigation-last"`
}
