...
func main() {
	...
	sb.WriteString("# Vuja commands\n\n")
	sb.WriteString("This directory contains all modular CLI command specifications and autocompletion definitions supported by **Vuja**. Every command is defined as a `spec.Spec` registered via package `init()` functions and grouped into category subdirectories.\n\n")
