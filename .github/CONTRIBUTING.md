# Contributing to Vuja

Thank you for your interest in Vuja. We welcome community contributions and
appreciate your time and effort in helping improve the project. Before getting
...
- You grant the Vuja maintainers and users the right to use, modify, and
  distribute it under the 0BSD license (see LICENSE file)
- To the extent your contribution is covered by patents, you grant a perpetual,
  worldwide, non-exclusive, royalty-free, irrevocable license to the Vuja
  maintainers and users to make, use, sell, offer for sale, import, and
  otherwise transfer your contribution as part of the project.
...
- Steps to reproduce, including operating system, and Vuja version
